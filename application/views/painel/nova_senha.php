				...
				<div class="login-wrapper">
					...
					<div class="row">
						<div class="login-wrapper_form">
							<form action="<?= base_url().'login/novaSenha'; ?>" method="POST" class="form form-group login-form">
								<label for="login" class="login-form_label">
									<input type="password" name="senha" class="form-control login-form_input__text" placeholder="Sua nova senha" required autofocus>
								</label>
								<label for="senha" class="login-form_label">
									<input type="password" name="senha_verifica" class="form-control login-form_input__text" placeholder="Confirme sua nova senha" required>
								</label>
